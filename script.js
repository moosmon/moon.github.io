...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = '¿Como crees?';
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = '¡¿Segurisimo?!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
        ...
        case 2:
            ...
            document.getElementById('noBtn').innerHTML = '100% Seguro):???';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
            document.getElementById('sadGifContainer2').style.display = 'none';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = 'Andaleeee';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Solo piensalo, va?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'Pero muy muy muy muy muy muy triste';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'Victorio andaleeee, si?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 11:
            ...
            document.getElementById('noBtn').innerHTML = 'Ah vedaaaa, POR FAVOR';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'Andale, o me corto las venas con un pan';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 14:
            ...
            document.getElementById('noBtn').innerHTML = 'NO, se me rompeeee... ya di que si Victorillo';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
            ...
            break;
        case 17:
            document.getElementById('noBtn').innerHTML = 'Victorillo, por favooooooor';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 18:
            document.getElementById('noBtn').innerHTML = 'Vicky';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
    ...
    // Hacer que el botón "Sí" crezca
        ...
        case 20:
                document.getElementById('noBtn').innerHTML = 'Añañe';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
